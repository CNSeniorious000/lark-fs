"""Dependency root for the HMR reloader (see hmr.py).
...
Kept separate from hmr.py because the reloader re-executes its entry on every reload,
and re-executing hmr.py would recurse into itself.
"""
